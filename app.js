  ...
  if (body.object === "instagram") {
    ...
    body.entry.forEach(async function(entry) {
      ...
      entry.messaging.forEach(async function(webhookEvent) {
        ...
        // Get the receiver IGSID
        let receiverIgsid = webhookEvent.recipient.id;
        await config.setPageToken(webhookEvent.recipient.id);
        ...
        let receiveMessage = new Receive(users[senderIgsid], webhookEvent, receiverIgsid);
